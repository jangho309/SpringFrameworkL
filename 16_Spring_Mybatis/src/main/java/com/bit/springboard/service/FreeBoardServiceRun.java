...
public class FreeBoardServiceRun {
    public static void main(String[] args) {
        ...
        boardDto.setTitle("자유게시글8");
        boardDto.setContent("자유게시글 8번입니다.");
        ...
        modifyBoardDto.setId(8);
        modifyBoardDto.setTitle("자유게시글8 수정");
        modifyBoardDto.setContent("자유게시글 8번입니다.-수정됨");
