            ...
            <div class="container mt-3 w-50">
                <form id="updateForm" action="#" method="post">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" id="regdate" name="regdate" value='<javatime:format value="${freeBoard.regdate}" pattern="yyyy-MM-dd"/>' required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="moddate">수정일</label>
                        <input type="text" class="form-control" id="moddate" name="moddate" value='<javatime:format value="${freeBoard.moddate}" pattern="yyyy-MM-dd"/>' required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="cnt">조회수</label>
                        <input type="text" class="form-control" id="cnt" name="cnt" value="${freeBoard.cnt}" required>
                    </div>
                    <div class="form-group mt-3">
                    ...
                    <div class="container mt-3 mb-5 w-50 text-center">
                        ...
                        <button type="button" id="btn-delete" class="btn btn-outline-secondary ml-2" onclick="location.href='/board/deleteBoard.do?boardNo=${getBoard.id}&type=notice'">삭제</button>
                    </div>
                </form>
            </div>
        </main>
