...
//    }
    ...
    // 1-4. Command 객체와 @ModelAttribute 어노테이션을 이요한 데이터 받기
    ...
    public String nameTelGet(Model model){
        System.out.println("namteTelGet 메소드 실행");
...
//        model.addAttribute("nameTelList", nameTelService.getNameTelList());
        ...
        // HttpServletRequets 객체의 setAttribute(키, 밸류);
//        request.setAttribute("nameTelList", nameTelService.getNameTelList());
        ...
        // 다른 동작(이벤트나 요청을 발생시키면) 계속해서 30분으로 초기화된다.
